...
public class TwitchOAuth : MonoBehaviour
{
    ...
    private readonly string loginSuccessUrl = "https://rociotome.com/success-buttonica-login";
    private readonly string loginFailUrl = "https://rociotome.com/fail-buttonica-login";
    ...
    private bool CheckAvailablePort()
    {
        ...
        Debug.Log("Can't find any available port");
        return false;
    }
